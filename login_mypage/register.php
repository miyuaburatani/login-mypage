...
<body>
    ...
    <form action="register_confirm.php" method="post" enctype="multipart/form-data">
        ...
        <h2>会員登録</h2>
            ...
            <input type="text" class="formbox" size="40" name="mail" pattern="^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" required></div>
        <div class="password">
        ...
        <label>プロフィール写真</label><br>
          ...
          <input type="file" size="40" name="picture">
           ...
           <div class="comments">
        <label>コメント</label><br>
        <textarea rows="5" cols="45" name="comments"></textarea></div>
        <div class="toroku">
